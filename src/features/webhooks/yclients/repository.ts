...
import type { YclientsWebhookStoreResult } from "./handler";
import type { YclientsWebhookPayload } from "./validation";
...
export async function storeYclientsWebhookEvent(
  ...
  if (error) {
    throw new Error("YCLIENTS webhook storage failed.");
  }
